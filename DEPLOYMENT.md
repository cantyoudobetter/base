...
sudo service unicorn_dpw <start|stop|restart>
sudo service sidekiq_dpw <start|stop>
```
...
```
/home/deployer/apps/dpw/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_dpw restart
sudo service sidekiq_dpw stop
sudo service sidekiq_dpw start
```
